...
const paths = {
    ...
    vendors: {
        styles: 'src/assets/vendors/css/*.css',
        scripts: 'src/assets/vendors/js/*.js',
    ...
    other: {
        src: ['src/assets/**/*','!src/assets/{images,scripts,sass,vendors}','!src/assets/{sass,images,scripts,vendors}/**/*'],
        dest: ['dist/assets']
    },
    package: {
...
export const dev = gulp.series(clean, concatStyles,concatScripts, gulp.parallel(styles,scripts,images,copy),serve,watch);
export const build = gulp.series(clean, concatStyles,concatScripts,gulp.parallel(styles,scripts,images,copy));
